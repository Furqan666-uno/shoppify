...
class Customer(models.Model):
    user= models.ForeignKey(User, on_delete= models.CASCADE) #here foreign key User is imported from django.contrib
    ...
    def __str__(self):
        return str(self.id) # id is by default generated by django
